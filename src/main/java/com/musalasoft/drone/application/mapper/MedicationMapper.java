...
public interface MedicationMapper {
    ...
    List<MedicationDto> requestToDtoList(List<MedicationRequest> requests);

    List<Medication> dtoToModelList(List<MedicationDto> medications);

    List<MedicationDto> modelToDtoList(List<Medication> medications);
}
